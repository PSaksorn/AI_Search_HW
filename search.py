...
def depthFirstSearch(problem: SearchProblem):
    ...
    while not fringe.isEmpty():
        ...
        for succ_state, succ_action, _step_cost in problem.getSuccessors(state):
            if succ_state not in visited:
                fringe.push((succ_state, actions + [succ_action]))
    ...
    while not fringe.isEmpty():
        ...
        for succ_state, succ_action, step_cost in problem.getSuccessors(state):
            if succ_state not in visited:
                ...
                fringe.push(
                    (succ_state, actions + [succ_action], new_cost),
                    new_cost
                )
...
def aStarSearch(problem: SearchProblem, heuristic=nullHeuristic):
    ...
    while not fringe.isEmpty():
        ...
        if g_cost != best_g.get(state, None):
            continue
        ...
        for succ_state, succ_action, step_cost in problem.getSuccessors(state):
            ...
            if succ_state not in best_g or new_g < best_g[succ_state]:
                best_g[succ_state] = new_g
                new_f = new_g + heuristic(succ_state, problem)
                fringe.push((succ_state, actions + [succ_action], new_g), new_f)
